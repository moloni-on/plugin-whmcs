...
return [
    ...
    'login_intro' => 'Insere as tuas credenciais de API do Moloni ON para autorizar esta instalação do WHMCS.',
    'developer_id' => 'ID de cliente da API',
    'client_secret' => 'Client secret',
    'connect' => 'Ligar',
    'credentials_required' => 'Indica o ID de cliente e o client secret da API.',
    ...
    'doctype_proFormaInvoice' => 'Fatura Proforma',
    ...
    'document_sets_unavailable' => 'Não foi possível carregar as séries do Moloni ON. Confirma que a tua empresa tem uma série definida no Moloni ON e atualiza esta página.',
    ...
    'setting_payment_method_help' => 'Usado quando o gateway de pagamento da encomenda não corresponde a nenhum método de pagamento do Moloni ON. Só é adicionado a tipos de documento com pagamentos.',
    ...
    'setting_custom_reference_help' => 'Campo personalizado de produto do WHMCS cuja descrição contém a referência Moloni ON de um produto de alojamento. Deixa em Nenhum para usar a referência predefinida.',
    'setting_exemption_reason' => 'Motivo de isenção de imposto',
    'setting_exemption_reason_help' => 'Motivo de isenção aplicado automaticamente a qualquer linha sem IVA (ex.: M07). Aparece como lista quando a tua zona fiscal define códigos de isenção; caso contrário, é introduzido como texto livre.',
    ...
    'tools_coming_soon' => 'Mais ferramentas em breve.',
