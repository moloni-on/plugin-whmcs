...
return [
    ...
    'setting_send_email' => 'Email the document to the customer after creating it',
    'setting_send_email_help' => 'Only applies when the document status is Closed; drafts are never emailed.',
    'setting_option_none' => '— None —',
    'settings_product_mapping' => 'Product settings',
    ...
    'setting_measurement_unit' => 'Unit of measure',
