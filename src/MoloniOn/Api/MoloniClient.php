...
use MoloniOn\GraphQL\Mutations\CreateCustomer;
...
use MoloniOn\GraphQL\Mutations\CreateProduct;
use MoloniOn\GraphQL\Mutations\CreateTax;
...
use MoloniOn\GraphQL\Queries\GetCompanies;
use MoloniOn\GraphQL\Queries\GetCompany;
use MoloniOn\GraphQL\Queries\GetCountries;
use MoloniOn\GraphQL\Queries\GetCurrencyExchanges;
use MoloniOn\GraphQL\Queries\GetCustomerNextNumber;
use MoloniOn\GraphQL\Queries\GetCustomers;
use MoloniOn\GraphQL\Queries\GetDocument;
